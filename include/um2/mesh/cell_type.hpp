...
constexpr auto vtk2xdmf(vtk_cell_type vtk_type) -> xdmf_cell_type
{
  switch (vtk_type) {
...
constexpr auto vtk2xdmf(int8_t vtk_type) -> int8_t
{
  switch (vtk_type) {
...
constexpr auto abaqus2xdmf(abaqus_cell_type abq_type) -> xdmf_cell_type
{
  switch (abq_type) {
...
constexpr auto abaqus2xdmf(int8_t abq_type) -> int8_t
{
  switch (abq_type) {
...
constexpr auto xdmf2vtk(xdmf_cell_type xdmf_type) -> vtk_cell_type
{
  switch (xdmf_type) {
...
constexpr auto xdmf2vtk(int8_t xdmf_type) -> int8_t
{
  switch (xdmf_type) {
...
constexpr auto isLinear(abaqus_cell_type abq_type) -> bool
{
  switch (abq_type) {
  case abaqus_cell_type::cp_s3:
  case abaqus_cell_type::cp_s4:
...
constexpr auto isLinear(vtk_cell_type vtk_type) -> bool
{
  switch (vtk_type) {
  case vtk_cell_type::triangle:
  case vtk_cell_type::quad:
...
constexpr auto pointsInXdmfCell(int8_t xdmf_type) -> len_t
{
  switch (xdmf_type) {
  case static_cast<int8_t>(xdmf_cell_type::triangle):
    return 3;
